...
TriggerGroup.CreateHandler(function (triggerIdList) {
    ...
    var InitTrigger = function () {
        TriggerDef.LogMsg("运行关卡脚本 Handler_ActiveLevel_2, 骷髅废墟, InitTrigger()");
        //================================== 定义变量和一些默认操作 ==================================//
        // 常量定义
        ...
        // 创建守护单位
        TriggerAction.CreateGuideUnit(FRIEND_GUIDE_CORPS_ID_LV1, TriggerDef.CAMP.HUMAN, 1); // corpsCid, camp, posIndex
        TriggerAction.CreateGuideUnit(FRIEND_GUIDE_CORPS_ID_LV2, TriggerDef.CAMP.HUMAN, 2); // corpsCid, camp, posIndex
        ...
        posHuman.y -= 5;
        TriggerAction.CreateCommanderFightUnit(TriggerDef.CAMP.HUMAN, posHuman, 21011); // 战场弓箭手
        //================================== 添加触发器 ==================================//
...
//                    TriggerAction.CreateTimeLineAndRun("tower_defense"); // 时间线出兵
        ...
        // 每隔 30 秒增加一次筹码值
        g_triggerIdAddAward = TriggerAction.CreateAddChipTrigger(triggerIdList, TriggerDef.CAMP.HUMAN, 30);
